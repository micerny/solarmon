...
class Growatt:
    ...
    def read(self):
        ...
        #print('Pac1 P: ' + str(read_double(row, 40)));
        #print('Pac1 L: ' + str(read_single(row, 41)));
...
#            'Epv1_total': read_double(row, 61),     # 0.1kWh,   Epv1_total H,       PV Energy total
                                                    # 0.1kWh,   Epv1_total L,       PV Energy total
            'Epv2_today': read_double(row, 63),     # 0.1kWh,   Epv2_today H,       PV Energy today
...
#            'Epv2_total': read_double(row, 65),     # 0.1kWh,   Epv2_total H,       PV Energy total
        ...
        #row = self.client.read_input_registers(2000, 100, unit=self.unit)
        #if type(row) is ModbusIOException:
        #    return None

        #print('Pac1 P: ' + str(read_double(row, 40)));
        #print('Pac1 P: ' + str(read_double(row, 44)));
        #print('Pac1 P: ' + str(read_double(row, 48)));


#        row = self.client.read_input_registers(105, 8, unit=self.unit)
#        print('FaultCode' + str(row.registers[0]))
